...
local function build_hud_text()
    local ass = {
        ...
        "{\\b1\\1c&H0089B4FA&}🧠 SMART-LANG: PIPELINE AUTOMÁTICO COMPLETO:{\\b0\\1c&H00BAC2DE&}\\N",
        "  • {\\b1\\1c&H00A6E3A1&}a{\\b0} : Trocar áudio (legenda troca junto pro idioma certo!)\\N",
        ...
        "  • {\\b1\\1c&H00F5C2E7&}Auto:{\\b0} Seleciona melhor legenda baseado no áudio (EN→EN, PT→PT, JA→EN)\\N",
        "  • {\\b1\\1c&H00F5C2E7&}Auto:{\\b0} Sem legenda? Baixa automaticamente (subliminal multi-provider)\\N",
        "  • {\\b1\\1c&H00F5C2E7&}Auto:{\\b0} Sincroniza com ffsubsync em background após selecionar/baixar\\N",
