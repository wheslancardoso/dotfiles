...
local function build_hud_text()
    local ass = {
        ...
        "  • {\\b1\\1c&H00A6E3A1&}z{\\b0} / {\\b1\\1c&H00A6E3A1&}Z{\\b0} : Atrasar / Adiantar legenda em 50ms (ajuste fino em tempo real)\\N",
        "  • {\\b1\\1c&H00A6E3A1&}Alt + z{\\b0} : Resetar atraso de legenda a 0.0s\\N",
        "  • {\\b1\\1c&H00A6E3A1&}Ctrl + Shift + z{\\b0} : Sincronização automática por voz (ffsubsync)\\N",
