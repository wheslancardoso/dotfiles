...
# Installation of main components (Batch Accelerated)
printf "\n%s - Installing ${SKY_BLUE}KooL's Hyprland necessary packages (Fast Batch Mode)${RESET} .... \n" "${NOTE}"

install_packages_batch "${hypr_package[@]}" "${hypr_package_2[@]}" "${Extra[@]}"
