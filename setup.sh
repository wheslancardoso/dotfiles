...
apply_dotfiles() {
    ...
    if [ -d "$DOTFILES_DIR/home/dot_config/mpv" ]; then
        ...
        [ -d "$DOTFILES_DIR/home/dot_config/mpv/shaders/Cinema" ] && ln -sfn "$DOTFILES_DIR/home/dot_config/mpv/shaders/Cinema" "$HOME/.config/mpv/shaders/Cinema"
    ...
    [ -f "$DOTFILES_DIR/scripts/continuar.sh" ] && ln -sf "$DOTFILES_DIR/scripts/continuar.sh" "$HOME/.local/bin/continuar"
    [ -f "$DOTFILES_DIR/scripts/continuar.sh" ] && ln -sf "$DOTFILES_DIR/scripts/continuar.sh" "$HOME/.local/bin/recentes"
